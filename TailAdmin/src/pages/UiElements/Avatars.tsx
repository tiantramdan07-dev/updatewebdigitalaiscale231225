...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | AiScale - React.js Admin Dashboard"
        description="This is React.js Avatars Dashboard page for AiScale - React.js Tailwind CSS Admin Dashboard"
      />
